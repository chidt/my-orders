...
const submit = () => {
    ...
    form.put(CategoriesRoutes.update.url({
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div class="min-w-0 flex-1">
                    <h1 class="text-2xl font-bold text-gray-900">Sửa danh mục: {{ category.name }}</h1>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>
                                    Danh mục này hiện có {{ category.products_count }} sản phẩm.
                                    Hãy cẩn thận khi thay đổi thông tin có thể ảnh hưởng đến sản phẩm.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-gray-500">
                                Chọn danh mục cha để tạo danh mục con. Tối đa 3 cấp độ. Không thể chọn danh mục con làm danh mục cha.
                            </p>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div v-if="category.products_count > 0 && !form.is_active" class="text-sm text-red-600">
                            <p>⚠️ Vô hiệu hóa danh mục sẽ ảnh hưởng đến {{ category.products_count }} sản phẩm</p>
                        </div>
                    </div>
                </div>
