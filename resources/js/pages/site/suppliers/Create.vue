...
const breadcrumbs = [
  ...
  { title: 'Quản lý nhà cung cấp', href: siteRoute.suppliers.index.url(props.site.slug), current: false },
  { title: 'Thêm nhà cung cấp', href: siteRoute.suppliers.create.url(props.site.slug), current: true },
];
    ...
    <div class="min-h-screen bg-gray-50">
      <div class="mx-auto max-w-4xl py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
          ...
          <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
              <div class="flex items-center space-x-4">
                <Link
                  :href="siteRoute.suppliers.index.url(site.slug)"
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-700">
                    Thêm nhà cung cấp mới cho {{ site.name }}.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="rounded-lg bg-white shadow">
              <form class="space-y-6 p-6" @submit.prevent="submit">
                <div class="grid gap-6 md:grid-cols-2">
                  ...
                  <!-- Person in charge -->
                  <div>
                    <Label for="person_in_charge">Người phụ trách</Label>
                    <Input
                      id="person_in_charge"
                    ...
                    <InputError
                      class="mt-2"
                      :message="form.errors.person_in_charge"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                      Số điện thoại theo định dạng quốc tế hoặc trong nước, ví dụ: 0901234567 hoặc
                      +84901234567.
                    </p>
                    <InputError
                      class="mt-2"
          ...
          <!-- Tips -->
          <div class="mt-8 rounded-lg bg-indigo-50 p-5 text-sm text-indigo-900">
            <p class="font-medium">💡 Gợi ý</p>
            <ul class="mt-2 list-inside list-disc space-y-1">
              <li>Có thể tạo nhiều nhà cung cấp có cùng tên trong cùng một site.</li>
              <li>Nên ghi rõ người phụ trách để dễ liên hệ khi đặt hàng.</li>
              <li>Không thể xóa nhà cung cấp khi đã có sản phẩm liên kết.</li>
            </ul>
          </div>
        </div>
      </div>
