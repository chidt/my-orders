...
const breadcrumbs = [
  ...
  { title: 'Quản lý nhà cung cấp', href: siteRoute.suppliers.index.url(props.site.slug), current: false },
  {
    ...
    href: siteRoute.suppliers.edit.url([props.site.slug, props.supplier.id]),
    current: true,
  },
];
...
const submit = () => {
  form.put(siteRoute.suppliers.update.url([props.site.slug, props.supplier.id]));
};
</script>
              ...
              <div class="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm text-gray-700">
                    Cập nhật thông tin cho nhà cung cấp {{ supplier.name }}.
                  </p>
                </div>
              </div>
            </div>
