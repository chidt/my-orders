...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 px-4 py-8 sm:px-6 lg:px-8">
            ...
            <!-- Help Section -->
            <div class="rounded-lg border bg-indigo-50 p-6">
                <h3 class="mb-2 text-sm font-medium text-indigo-900">
                    💡 Gợi ý
                </h3>
                <ul class="space-y-1 text-sm text-indigo-800">
                    <li>
                        • Mã kho nên ngắn gọn và dễ nhớ (VD: W001, MAIN, KHO-HN)
                    </li>
                    <li>
                        • Tên kho nên mô tả rõ ràng vị trí hoặc chức năng của
                        kho
                    </li>
                    <li>
                        • Địa chỉ nên đầy đủ để dễ dàng vận chuyển và quản lý
                    </li>
                    <li>
                        • Sau khi tạo kho, bạn có thể thêm các vị trí lưu trữ
                        bên trong
                    </li>
                </ul>
            </div>
