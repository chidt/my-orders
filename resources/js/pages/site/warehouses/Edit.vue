            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <div class="px-4 py-6 sm:px-0">
                    ...
                    <div class="mt-8">
                        ...
                        <!-- Warning Section -->
                        <div
                            class="mt-8 rounded-lg border border-amber-200 bg-amber-50 p-6"
                        >
                            ...
                            <ul class="space-y-1 text-sm text-amber-800">
                                <li>
                                    • Thay đổi mã kho có thể ảnh hưởng đến các
                                    báo cáo và tài liệu có sẵn
                                </li>
                                <li>
                                    • Nếu kho đã có vị trí lưu trữ, việc thay
                                    đổi thông tin sẽ được áp dụng cho tất cả vị
                                    trí
                                </li>
                                <li>
                                    • Địa chỉ kho được sử dụng cho việc vận
                                    chuyển và báo cáo logistics
                                </li>
                            </ul>
                        </div>
                    </div>
